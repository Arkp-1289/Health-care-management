...
<section>
	<div class="w-80">
     <div class="form-box">
     	<h1>Contact Us</h1>
     	<hr>
     	<form method="post" action="info_submit.php">
     		<label for="username"><b>Your name :</b></label><br/>
				...
				<br/>
				<textarea id="message" name="message"  placeholder="Enter Your problem" required></textarea>
				<br/><br/>
