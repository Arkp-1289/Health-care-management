	...
	<div class="w-80">
     <div class="form-box">
     	...
     	<form method="post" action="form_submit.php">
				...
				<input type="text" name="name" id="name" placeholder="Ex: abcd" required/>
				<br/><br/>

				<label for="email"><b>Email :</b></label><br/>
				<input type="email" name="email" id="email" placeholder="Ex: abcd@gmail.com" required/>
				<br/><br/>

				<label for="mobile"><b>Mobile :</b></label><br/>
				<input type="number" name="mobile" id="mobile" placeholder="Ex: 1234567890" required/>
				<br/><br/>

				<label for="username"><b>Username :</b></label><br/>
				<input type="text" name="username" id="username" placeholder="Ex: abcd_sd" required/>
				<br/><br/>
